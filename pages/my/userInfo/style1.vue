	...
	<view>
		<view class="tui-mybg-box">
			...
			<view class="tui-header-btm">
				<view @click="navigateTo('/pages/my/recharge/recharge')" class="tui-btm-item">
				...
				<view class="tui-btm-item">
					<view class="tui-btm-num">{{memberinfo.agent.income}}</view>
					<view class="tui-btm-text">佣金</view>
				</view>
			</view>
		</view>
		<view class="tui-content-box">
			<view class="vip-box" style="margin-bottom: 20rpx;">
				<tui-list-cell backgroundColor="#5c5c5c" :arrow="false" :hover="false" padding="0" unlined :lineLeft="false"
					@click="navigateTo('/pages/my/vip_paid/index')">
			...
			<view class="tui-box tui-order-box">
				<tui-list-cell :arrow="true" padding="0" unlined :lineLeft="false"
					@click="navigateTo('/pages/my/myOrder/myOrder?ptype=1')">
					<view class="tui-cell-header">
				...
				<view class="tui-order-list">
					<view class="tui-order-item" @tap="navigateTo('/pages/my/myOrder/myOrder?currentTab=1&ptype=1')">
						<view class="tui-icon-box">
							<image src="/static/images/mall/my/icon_daifukuan_3x.png" class="tui-order-icon"></image>
							<!--<view class="tui-badge tui-badge-red">1</view>-->
						</view>
					...
					<view class="tui-order-item" @tap="navigateTo('/pages/my/myOrder/myOrder?currentTab=2&ptype=1')">
						<view class="tui-icon-box">
							<image src="/static/images/mall/my/icon_daifahuo_3x.png" class="tui-order-icon"></image>
							<!--<view class="tui-badge tui-badge-red">1</view>-->
						</view>
					...
					<view class="tui-order-item" @tap="navigateTo('/pages/my/myOrder/myOrder?currentTab=3&ptype=1')">
						<view class="tui-icon-box">
							<image src="/static/images/mall/my/icon_daishouhuo_3x.png" class="tui-order-icon"></image>
						</view>
						<view class="tui-order-text">待收货</view>
					</view>
					<view class="tui-order-item" @tap="navigateTo('/pages/my/myOrder/myOrder?currentTab=5&ptype=1')">
						<view class="tui-icon-box">
							<image src="/static/images/mall/my/icon_pingjia_3x.png" class="tui-order-icon"></image>
							<view class="tui-badge tui-badge-red" v-if="false">12</view>
						</view>
					...
					<view class="tui-order-item" @tap="navigateTo('/pages/my/myOrder/myOrder?currentTab=6&ptype=1')">
						<view class="tui-icon-box">
							<image src="/static/images/mall/my/icon_tuikuan_3x.png" class="tui-order-icon"></image>
							<!--<view class="tui-badge tui-badge-red">2</view>-->
						</view>
			...
			<view class="tui-box tui-tool-box">
				<tui-list-view>
					...
					<tui-list-cell @tap="navigateTo('/pages/my/maidan/index')" :arrow="true">
						<view class="tui-item-box">
							<view class="tui-icon-box">
								<image src="/static/images/mall/my/fx.png" class="tui-tool-icon"></image>
							</view>
							<view class="tui-list-cell_name">直接付款</view>
						</view>
					</tui-list-cell>
									...
									<view>
										<view class="tui-pro-price">
											<text v-if="item.is_points_goods==1"
												class="tui-sale-price">积分:{{ item.pay_points }}</text>
											<text v-if="item.is_points_goods!=1"
